/*To implement a C++ program to store binary numbers using doubly linked lists
and to perform operations such as computing 1's and 2's compliment,
and adding two binary numbers*/
